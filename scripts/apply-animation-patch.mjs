...
const animationController = [
  "function AnimationController({scene,clips,index,playing}:{scene:THREE.Object3D|null;clips:THREE.AnimationClip[];index:number;playing:boolean}){",
...
if (!s.includes('AnimationController')) s = s.replace(marker, animationController + marker)
